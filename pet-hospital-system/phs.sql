...
-- Records of phs_case
-- ----------------------------
INSERT INTO `phs_case` VALUES (4, 1, '病例A', '贵宾十五，2岁，雌性。该犬平时主要饲喂犬粮，偶尔吃少量零食。今年未免疫，驱虫。今日食欲下降，精神尚可，最初出现黄色脓性眼分泌物，鼻头干燥。两天前开始频繁的咳嗽，偶有少量白色粘液咳出，粪便软。体温39.5℃，体重3.5kg，心率128次/min、呼吸28次/min。睑结膜潮红，水润度下降，鼻头干燥，有少量黄色鼻液，诱咳反应阳性。目前临床上对于犬瘟热是采用特异性的抗病毒与对症支持疗法相结合的治疗方法。由于未按时免疫的动物以及母源抗体消耗殆尽的幼年动物体内缺少可以抵抗病毒的抗体，或者由于自身免疫力的下降，不足以产生足够的抗体来对抗体内的病毒，所以外源性的抗体补给在治疗过程中显得尤为重要。同时，干扰素，胸腺肽等生物制剂在抗病毒治疗过程中也起到积极的作用。', 'http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/b9d3a1fa-57e3-4235-859d-06f131886ef8.jpg&&http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/6545b4d9-9254-4a41-b759-00710531f49e.png&&http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/e05dbe65-4758-48d3-832b-bf220301e4cf.png', 'http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/f840a4a2-99dd-430c-9ea8-14763a344619.mp4');
...
-- ----------------------------
INSERT INTO `phs_disease` VALUES (1, 1, '犬瘟热', 'http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/9a6f0c79-086e-46a8-8ca2-7f5ec49816ff.png&&http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/22/fd8d8bb1-16f2-4bcb-8d5e-9424c48228bb.jpg', '');
...
INSERT INTO `phs_quiz` VALUES (22, 1, 'test', 'testAA&&BB&&CC&&testDD', 'C');
...
INSERT INTO `phs_work` VALUES (8, 1, 'test', 'update', 'test', 'http://pet-hospital-system.oss-cn-shanghai.aliyuncs.com/files/2023/04/24/e00976c6-8a68-4b7c-90a3-2fa00a149957.mp4');
